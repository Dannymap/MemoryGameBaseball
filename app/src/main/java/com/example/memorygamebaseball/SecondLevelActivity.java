...
public class SecondLevelActivity extends AppCompatActivity {
    ...
    private static final long GAME_DURATION = 40000; // Duración del juego en milisegundos (40 segundos)
    private static final long TICK_INTERVAL = 1000; // Intervalo de actualización del contador en milisegundos (1 segundo)
    private static final int TOTAL_PAIRS = 4; // Número total de parejas en el juego
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Lista de recursos de imágenes aleatorias para el segundo nivel
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.contacto) {
            ...
            Intent intent = new Intent(SecondLevelActivity.this, ContactActivity.class);
    ...
    private void startNewLevel() {
        ...
        if (playerName != null && !playerName.isEmpty()) {
            ...
            int level2Score = calculateScore(progressBar.getProgress());
