...
public class FirstLevelActivity extends AppCompatActivity {
    ...
    private static final long GAME_DURATION = 30000; // Duración del juego en milisegundos (30 segundos)
    private static final long TICK_INTERVAL = 1000; // Intervalo de actualización del contador en milisegundos (1 segundo)
    private static final int TOTAL_PAIRS = 2; // Número total de parejas en el juego
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Lista de recursos de imágenes aleatorias para el primer nivel
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.contacto) {
            ...
            Intent intent = new Intent(FirstLevelActivity.this, ContactActivity.class);
    ...
    private int calculateScore(long timeRemaining) {return (int) (timeRemaining / 1000); }
    ...
    private void startNewLevel() {
        ...
        if (playerName != null && !playerName.isEmpty()) {
            ...
            intent.putExtra("JUGADOR", playerName);
            int level1Score = calculateScore(progressBar.getProgress());
